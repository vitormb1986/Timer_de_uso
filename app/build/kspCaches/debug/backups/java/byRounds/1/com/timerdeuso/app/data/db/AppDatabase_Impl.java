...
public final class AppDatabase_Impl extends AppDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        db.execSQL("CREATE TABLE IF NOT EXISTS `monitored_apps` (`packageName` TEXT NOT NULL, `appName` TEXT NOT NULL, `timeLimitMinutes` INTEGER NOT NULL, `isEnabled` INTEGER NOT NULL, `isSilencedUntilMidnight` INTEGER NOT NULL, PRIMARY KEY(`packageName`))");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '0428b975760c43a595d96c3ac35b7e45')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        final HashMap<String, TableInfo.Column> _columnsMonitoredApps = new HashMap<String, TableInfo.Column>(5);
        ...
        _columnsMonitoredApps.put("timeLimitMinutes", new TableInfo.Column("timeLimitMinutes", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonitoredApps.put("isEnabled", new TableInfo.Column("isEnabled", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsMonitoredApps.put("isSilencedUntilMidnight", new TableInfo.Column("isSilencedUntilMidnight", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoMonitoredApps.equals(_existingMonitoredApps)) {
          return new RoomOpenHelper.ValidationResult(false, "monitored_apps(com.timerdeuso.app.data.model.MonitoredApp).\n"
                  + " Expected:\n" + _infoMonitoredApps + "\n"
                  + " Found:\n" + _existingMonitoredApps);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "0428b975760c43a595d96c3ac35b7e45", "83572a772be2c7dbfb11f32ff08480c1");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "monitored_apps");
  }
